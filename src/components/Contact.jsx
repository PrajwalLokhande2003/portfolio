...
const Contact = ()=>{
    ...
    return(
        ...
        <div className="para">If you have any questions or want to work together, feel free to send me a message.</div>
        <div className="contact_me">
        <div className="contact_detail">
            <div className="title">Contact Information</div>
            <a href="tel:9665513622" className=" text-decoration-none text-light">
            <div className="phone">
